...
#####	-Evaluar la relación entre la carga de trabajo (IP) y la efectividad independiente en el “fildeo” (FIP)  para garantizar un análisis completo del rendimiento individual de los pitchers con mayor participación.
#####	-Evaluar la relación de efectividad (ERA) con la métrica de durabilidad (IP) para identificar a los pitchers más eficientes de acuerdo a su participación
#####	-Clasificar el top 10 de los pitchers con mayor participación en la MLB 2022, ordenándolos según su WHIP para identificar los más en control de hits & walks.
...
En primer lugar se puede observar claramente que la mayor cantidad de juegos ganados se encuentra entre los jugadores con una ERA de entre 1,14 hasta 3. 

##  *Pitchers con mejor ERA respecto a innings lanzados.*

```{r ERA IP}
era_ip <- mlb_players %>% arrange(ERA, IP)
