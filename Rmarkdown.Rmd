...
ggplot(mlb_players, aes(x = Age, y = IP, fill())) + 
  geom_point() +
  stat_ellipse(type = "t") +
  stat_ellipse(type = "norm", linetype = 2) + labs(title = "Relación entre las entradas lanzadas y la edad",  x = "Edad de los pitchers", y = "Innings pitched/entradas lanzadas") +
  theme_grey()
```
...
sin embargo los resultados no suponen la existencia entre una correlación directa entre ambas variables (Whip y edad).
